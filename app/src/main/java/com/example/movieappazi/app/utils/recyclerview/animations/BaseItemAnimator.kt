package com.example.movieappazi.app.utils.recyclerview.animations
...
abstract class BaseItemAnimator : SimpleItemAnimator() {
    ...
    override fun isRunning(): Boolean {
        return (pendingAdditions.isNotEmpty() || pendingChanges.isNotEmpty() || pendingMoves.isNotEmpty() || pendingRemovals.isNotEmpty() || moveAnimations.isNotEmpty() || removeAnimations.isNotEmpty() || addAnimations.isNotEmpty() || changeAnimations.isNotEmpty() || movesList.isNotEmpty() || additionsList.isNotEmpty() || changesList.isNotEmpty())
    }
    ...
    override fun recordPreLayoutInformation(
        ...
        val recordPreLayoutInformation =
