...
import com.example.movieappazi.databinding.MainScreenUpcomingMoviesBlockBinding
import com.example.movieappazi.ui.movie.all_movies_screen.adapter.base.AllMoviesPopularHorizontalItem

class AllMoviesUpcomingBlockFingerPrint(
    private val fingerprintsList: List<ItemFingerprint<*, *>>,
    private val viewPool: RecyclerView.RecycledViewPool,
) : ItemFingerprint<MainScreenUpcomingMoviesBlockBinding, AllMoviesPopularHorizontalItem> {

    override fun isRelativeItem(item: Item) = item is AllMoviesPopularHorizontalItem

    override fun getLayoutId() = R.layout.main_screen_upcoming_movies_block

    override fun getViewHolder(
        layoutInflater: LayoutInflater,
        parent: ViewGroup,
    ): BaseViewHolder<MainScreenUpcomingMoviesBlockBinding, AllMoviesPopularHorizontalItem> {
        val binding = MainScreenUpcomingMoviesBlockBinding.inflate(layoutInflater)
        ...
        return MainScreenUpcomingMoviesViewHolder(binding, fingerprintsList, viewPool)
    }
...
class MainScreenUpcomingMoviesViewHolder(
    binding: MainScreenUpcomingMoviesBlockBinding,
    fingerprints: List<ItemFingerprint<*, *>>,
    viewPool: RecyclerView.RecycledViewPool,
) : BaseViewHolder<MainScreenUpcomingMoviesBlockBinding, AllMoviesPopularHorizontalItem>(binding) {
