...
class UpcomingMoviesFingerPrint : ItemFingerprint<ObjectItemPortraitBinding, MovieAdapterModel> {
    ...
    override fun getViewHolder(
        ...
        parent: ViewGroup,
    ): BaseViewHolder<ObjectItemPortraitBinding, MovieAdapterModel> {
...
) : BaseViewHolder<ObjectItemPortraitBinding, MovieAdapterModel>(binding) {
